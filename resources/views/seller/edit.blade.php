          ...
          <div class="col">
            <div class="home_content text-center">
              ...
              <div class="booking_form_container">
                ...
                <form method="post">
                  {{@csrf_field()}}
                  Name:<input style="border:none" type="text" class=" booking_input" name="name" value="{{$profile->name}}" ></br>
                  Number:<input style="border:none" type="number" class=" booking_input" name="mobile" value="{{$profile->mobile}}"></br>
                  Username<input style="border:none" type="text" class=" booking_input" name="username" value="{{$profile->username}}"></br>
                  password:<input style="border:none" type="text" class="booking_input" name="password" value="{{$profile->password}}">
                </br>
                    <button class="booking_button">Update</button>
