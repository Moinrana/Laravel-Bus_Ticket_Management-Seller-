        ...
        <div class="ml-auto d-flex flex-row align-items-center justify-content-start">
          <nav class="main_nav">
            <ul class="d-flex flex-row align-items-start justify-content-start">
                ...
                <li class="active"><a href="/#">Ticket Requests</a></li>
          ...
          <div class="row">
            <div class="col">
              <div class="home_content text-center">
                <div class="home_title">Ticket Requests</div>
                      ...
                      <tr>
                        ...
                        <td>SeatNo</td>
                         ...
                         <tr>
                            ...
                            <td>{{$value->seatno}}</td>
                            <td><a href="{{route('seller.approve' ,['id'=>$value->historyid] )}}">approve</a></td>
                            <td><a href="{{route('seller.delete' , ['id'=>$value->historyid])}}">delete</a></td>
