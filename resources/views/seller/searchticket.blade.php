      ...
      <div class="ml-auto d-flex flex-row align-items-center justify-content-start">
        <nav class="main_nav">
          <ul class="d-flex flex-row align-items-start justify-content-start">
              ...
              <li class="active"><a href="/#">Search Ticket</a></li>
        ...
        <div class="row">
          <div class="col">
            <div class="home_content text-center">
              <div class="home_title">Search Ticket</div>
              <div class="booking_form_container">

                <form method="post">
                  {{@csrf_field()}}
                  username:<input type="text" class=" booking_input" name="username"></br>
                  Ticket Id:<input type="text" class=" booking_input" name="ticketid"></br>
                </br>
                    <button name="search_btn" class="booking_button">Search</button>
